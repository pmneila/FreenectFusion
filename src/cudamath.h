...
inline __host__ __device__ float4 make_float4(const float3& a, float w)
{
...
inline __device__ float length2(const float2& v)
{
...
inline __device__ float3 operator*(float s, const float3& a)
{
